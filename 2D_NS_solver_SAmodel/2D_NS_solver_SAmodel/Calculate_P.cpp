...
void Calculate_P()
{
	...
	//1.四个角点
	{
		...
		//1.4miubl
		{
			FaceI[1][1].miubl = 0.5 * (Cell[1][1].miubl + DummyIS[1][1].miubl);
			FaceJ[1][1].miubl = 0.5 * (Cell[1][1].miubl + DummyJW[1][1].miubl);
			FaceI[Imax - 1][1].miubl = 0.5 * (Cell[Imax - 1][1].miubl + DummyIS[Imax - 1][1].miubl);
			FaceJ[Imax][1].miubl = 0.5 * (Cell[Imax - 1][1].miubl + DummyJE[1][1].miubl);
			FaceI[Imax - 1][Jmax].miubl = 0.5 * (Cell[Imax - 1][Jmax - 1].miubl + DummyIN[Imax - 1][1].miubl);
			FaceJ[Imax][Jmax - 1].miubl = 0.5 * (Cell[Imax - 1][Jmax - 1].miubl + DummyJE[1][Jmax - 1].miubl);
			FaceI[1][Jmax].miubl = 0.5 * (Cell[1][Jmax - 1].miubl + DummyIN[1][1].miubl);
			FaceJ[1][Jmax - 1].miubl = 0.5 * (Cell[1][Jmax - 1].miubl + DummyJW[1][Jmax - 1].miubl);

			A1 = (Cell[1][1].miubl + Cell[2][1].miubl) * FaceJ[2][1].nx / 2;
			A2 = FaceJ[1][1].miubl * FaceJ[1][1].nx;
			A3 = (Cell[1][1].miubl + Cell[1][2].miubl) * FaceI[1][2].nx / 2;
			A4 = FaceI[1][1].miubl * FaceI[1][1].nx;
			Cell[1][1].miubl_x = (A1 - A2 + A3 - A4) / Cell[1][1].Vol;
			B1 = (Cell[1][1].miubl + Cell[2][1].miubl) * FaceJ[2][1].ny / 2;
			B2 = FaceJ[1][1].miubl * FaceJ[1][1].ny;
			B3 = (Cell[1][1].miubl + Cell[1][2].miubl) * FaceI[1][2].ny / 2;
			B4 = FaceI[1][1].miubl * FaceI[1][1].ny;
			Cell[1][1].miubl_y = (B1 - B2 + B3 - B4) / Cell[1][1].Vol;
			A1 = (Cell[1][Jmax - 1].miubl + Cell[2][Jmax - 1].miubl) * FaceJ[2][Jmax - 1].nx / 2;
			A2 = FaceJ[1][Jmax - 1].miubl * FaceJ[1][Jmax - 1].nx;
			A3 = FaceI[1][Jmax].miubl * FaceI[1][Jmax].nx;
			A4 = (Cell[1][Jmax - 1].miubl + Cell[1][Jmax - 2].miubl) * FaceI[1][Jmax - 1].nx / 2;
			Cell[1][Jmax - 1].miubl_x = (A1 - A2 + A3 - A4) / Cell[1][Jmax - 1].Vol;
			B1 = (Cell[1][Jmax - 1].miubl + Cell[2][Jmax - 1].miubl) * FaceJ[2][Jmax - 1].ny / 2;
			B2 = FaceJ[1][Jmax - 1].miubl * FaceJ[1][Jmax - 1].ny;
			B3 = FaceI[1][Jmax].miubl * FaceI[1][Jmax].ny;
			B4 = (Cell[1][Jmax - 1].miubl + Cell[1][Jmax - 2].miubl) * FaceI[1][Jmax - 1].ny / 2;
			Cell[1][Jmax - 1].miubl_y = (B1 - B2 + B3 - B4) / Cell[1][Jmax - 1].Vol;
			A1 = FaceJ[Imax][1].miubl * FaceJ[Imax][1].nx;
			A2 = (Cell[Imax - 1][1].miubl + Cell[Imax - 2][1].miubl) * FaceJ[Imax - 1][1].nx / 2;
			A3 = (Cell[Imax - 1][1].miubl + Cell[Imax - 1][2].miubl) * FaceI[Imax - 1][2].nx / 2;
			A4 = FaceI[Imax - 1][1].miubl * FaceI[Imax - 1][1].nx;
			Cell[Imax - 1][1].miubl_x = (A1 - A2 + A3 - A4) / Cell[Imax - 1][1].Vol;
			B1 = FaceJ[Imax][1].miubl * FaceJ[Imax][1].ny;
			B2 = (Cell[Imax - 1][1].miubl + Cell[Imax - 2][1].miubl) * FaceJ[Imax - 1][1].ny / 2;
			B3 = (Cell[Imax - 1][1].miubl + Cell[Imax - 1][2].miubl) * FaceI[Imax - 1][2].ny / 2;
			B4 = FaceI[Imax - 1][1].miubl * FaceI[Imax - 1][1].ny;
			Cell[Imax - 1][1].miubl_y = (B1 - B2 + B3 - B4) / Cell[Imax - 1][1].Vol;
			A1 = FaceJ[Imax][Jmax - 1].miubl * FaceJ[Imax][Jmax - 1].nx;
			A2 = (Cell[Imax - 1][Jmax - 1].miubl + Cell[Imax - 2][Jmax - 1].miubl) * FaceJ[Imax - 1][Jmax - 1].nx / 2;
			A3 = FaceI[Imax - 1][Jmax].miubl * FaceI[Imax - 1][Jmax].nx;
			A4 = (Cell[Imax - 1][Jmax - 1].miubl + Cell[Imax - 1][Jmax - 2].miubl) * FaceI[Imax - 1][Jmax - 1].nx / 2;
			Cell[Imax - 1][Jmax - 1].miubl_x = (A1 - A2 + A3 - A4) / Cell[Imax - 1][Jmax - 1].Vol;
			B1 = FaceJ[Imax][Jmax - 1].miubl * FaceJ[Imax][Jmax - 1].ny;
			B2 = (Cell[Imax - 1][Jmax - 1].miubl + Cell[Imax - 2][Jmax - 1].miubl) * FaceJ[Imax - 1][Jmax - 1].ny / 2;
			B3 = FaceI[Imax - 1][Jmax].miubl * FaceI[Imax - 1][Jmax].ny;
			B4 = (Cell[Imax - 1][Jmax - 1].miubl + Cell[Imax - 1][Jmax - 2].miubl) * FaceI[Imax - 1][Jmax - 1].ny / 2;
			Cell[Imax - 1][Jmax - 1].miubl_y = (B1 - B2 + B3 - B4) / Cell[Imax - 1][Jmax - 1].Vol;
		}
	}
	...
	for (i = 2; i <= Imax - 2; i++)
	{
		...
		FaceI[i][1].miubl = 0.5 * (Cell[i][1].miubl + DummyIS[i][1].miubl);
		FaceI[i][Jmax].miubl = 0.5 * (Cell[i][Jmax - 1].miubl + DummyIN[i][1].miubl);
		...
		A1 = (Cell[i][1].miubl + Cell[i + 1][1].miubl) * FaceJ[i + 1][1].nx / 2;
		A2 = (Cell[i][1].miubl + Cell[i - 1][1].miubl) * FaceJ[i][1].nx / 2;
		A3 = (Cell[i][1].miubl + Cell[i][2].miubl) * FaceI[i][2].nx / 2;
		A4 = FaceI[i][1].miubl * FaceI[i][1].nx;
		Cell[i][1].miubl_x = (A1 - A2 + A3 - A4) / Cell[i][1].Vol;
		B1 = (Cell[i][1].miubl + Cell[i + 1][1].miubl) * FaceJ[i + 1][1].ny / 2;
		B2 = (Cell[i][1].miubl + Cell[i - 1][1].miubl) * FaceJ[i][1].ny / 2;
		B3 = (Cell[i][1].miubl + Cell[i][2].miubl) * FaceI[i][2].ny / 2;
		B4 = FaceI[i][1].miubl * FaceI[i][1].ny;
		Cell[i][1].miubl_y = (B1 - B2 + B3 - B4) / Cell[i][1].Vol;
		A1 = (Cell[i][Jmax - 1].miubl + Cell[i + 1][Jmax - 1].miubl) * FaceJ[i + 1][Jmax - 1].nx / 2;
		A2 = (Cell[i][Jmax - 1].miubl + Cell[i - 1][Jmax - 1].miubl) * FaceJ[i][Jmax - 1].nx / 2;
		A3 = FaceI[i][Jmax].miubl * FaceI[i][Jmax].nx;
		A4 = (Cell[i][Jmax - 1].miubl + Cell[i][Jmax - 2].miubl) * FaceI[i][Jmax - 1].nx / 2;
		Cell[i][Jmax - 1].miubl_x = (A1 - A2 + A3 - A4) / Cell[i][Jmax - 1].Vol;
		B1 = (Cell[i][Jmax - 1].miubl + Cell[i + 1][Jmax - 1].miubl) * FaceJ[i + 1][Jmax - 1].ny / 2;
		B2 = (Cell[i][Jmax - 1].miubl + Cell[i - 1][Jmax - 1].miubl) * FaceJ[i][Jmax - 1].ny / 2;
		B3 = FaceI[i][Jmax].miubl * FaceI[i][Jmax].ny;
		B4 = (Cell[i][Jmax - 1].miubl + Cell[i][Jmax - 2].miubl) * FaceI[i][Jmax - 1].ny / 2;
		Cell[i][Jmax - 1].miubl_y = (B1 - B2 + B3 - B4) / Cell[i][Jmax - 1].Vol;
	}
	for (j = 2; j <= Jmax - 2; j++)
	{
		...
		FaceJ[1][j].miubl = 0.5 * (Cell[1][j].miubl + DummyJW[1][j].miubl);
		FaceJ[Imax][j].miubl = 0.5 * (Cell[Imax - 1][j].miubl + DummyJE[1][j].miubl);
		...
		A1 = (Cell[1][j].miubl + Cell[2][j].miubl) * FaceJ[2][j].nx / 2;
		A2 = FaceJ[1][j].miubl * FaceJ[1][j].nx;
		A3 = (Cell[1][j].miubl + Cell[1][j + 1].miubl) * FaceI[1][j + 1].nx / 2;
		A4 = (Cell[1][j].miubl + Cell[1][j - 1].miubl) * FaceI[1][j].nx / 2;
		Cell[1][j].miubl_x = (A1 - A2 + A3 - A4) / Cell[1][j].Vol;
		B1 = (Cell[1][j].miubl + Cell[2][j].miubl) * FaceJ[2][j].ny / 2;
		B2 = FaceJ[1][j].miubl * FaceJ[1][j].ny;
		B3 = (Cell[1][j].miubl + Cell[1][j + 1].miubl) * FaceI[1][j + 1].ny / 2;
		B4 = (Cell[1][j].miubl + Cell[1][j - 1].miubl) * FaceI[1][j].ny / 2;
		Cell[1][j].miubl_y = (B1 - B2 + B3 - B4) / Cell[1][j].Vol;
		A1 = FaceJ[Imax][j].miubl * FaceJ[Imax][j].nx;
		A2 = (Cell[Imax - 1][j].miubl + Cell[Imax - 2][j].miubl) * FaceJ[Imax - 1][j].nx / 2;
		A3 = (Cell[Imax - 1][j].miubl + Cell[Imax - 1][j + 1].miubl) * FaceI[Imax - 1][j + 1].nx / 2;
		A4 = (Cell[Imax - 1][j].miubl + Cell[Imax - 1][j - 1].miubl) * FaceI[Imax - 1][j].nx / 2;
		Cell[Imax - 1][j].miubl_x = (A1 - A2 + A3 - A4) / Cell[Imax - 1][j].Vol;
		B1 = FaceJ[Imax][j].miubl * FaceJ[Imax][j].ny;
		B2 = (Cell[Imax - 1][j].miubl + Cell[Imax - 2][j].miubl) * FaceJ[Imax - 1][j].ny / 2;
		B3 = (Cell[Imax - 1][j].miubl + Cell[Imax - 1][j + 1].miubl) * FaceI[Imax - 1][j + 1].ny / 2;
		B4 = (Cell[Imax - 1][j].miubl + Cell[Imax - 1][j - 1].miubl) * FaceI[Imax - 1][j].ny / 2;
		Cell[Imax - 1][j].miubl_y = (B1 - B2 + B3 - B4) / Cell[Imax - 1][j].Vol;
	}
	...
	for (i = 2; i <= Imax - 2; i++)
	{
		for (j = 2; j <= Jmax - 2; j++)
		{
			...
			A1 = (Cell[i][j].miubl + Cell[i + 1][j].miubl) * FaceJ[i + 1][j].nx / 2;
			A2 = (Cell[i][j].miubl + Cell[i - 1][j].miubl) * FaceJ[i][j].nx / 2;
			A3 = (Cell[i][j].miubl + Cell[i][j + 1].miubl) * FaceI[i][j + 1].nx / 2;
			A4 = (Cell[i][j].miubl + Cell[i][j - 1].miubl) * FaceI[i][j].nx / 2;
			Cell[i][j].miubl_x = (A1 - A2 + A3 - A4) / Cell[i][j].Vol;
			B1 = (Cell[i][j].miubl + Cell[i + 1][j].miubl) * FaceJ[i + 1][j].ny / 2;
			B2 = (Cell[i][j].miubl + Cell[i - 1][j].miubl) * FaceJ[i][j].ny / 2;
			B3 = (Cell[i][j].miubl + Cell[i][j + 1].miubl) * FaceI[i][j + 1].ny / 2;
			B4 = (Cell[i][j].miubl + Cell[i][j - 1].miubl) * FaceI[i][j].ny / 2;
			Cell[i][j].miubl_y = (B1 - B2 + B3 - B4) / Cell[i][j].Vol;
		}
	}
	...
	for (i = 1; i <= Imax - 1; i++)
	{
		...
		DummyIS[i][1].v_y = Cell[i][1].v_y;
		DummyIS[i][1].miubl_x = Cell[i][1].miubl_x;
		DummyIS[i][1].miubl_y = Cell[i][1].miubl_y;//物面边界
		DummyIN[i][1].T_x = DummyIN[i][1].T_y = DummyIN[i][1].u_x = DummyIN[i][1].u_y = DummyIN[i][1].v_x = DummyIN[i][1].v_y = DummyIN[i][1].miubl_x = DummyIN[i][1].miubl_y = 0;//远场边界
	}
	for (j = 1; j <= Jmax - 1; j++)
	{
		...
		DummyJW[1][j].v_y = Cell[Imax - 1][j].v_y;
		DummyJW[1][j].miubl_x = Cell[Imax - 1][j].miubl_x;
		DummyJW[1][j].miubl_y = Cell[Imax - 1][j].miubl_y;//左割缝
		...
		DummyJE[1][j].v_y = Cell[1][j].v_y;
		DummyJE[1][j].miubl_x = Cell[1][j].miubl_x;
		DummyJE[1][j].miubl_y = Cell[1][j].miubl_y;//右割缝
	}
}