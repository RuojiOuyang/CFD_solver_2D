...
public:
	...
	double QC[5];//控制体的对流通量积分（净无粘通量积分）
	double QV[5];//控制体的扩散通量积分（净粘性通量积分）
...
extern double Re;//雷诺数
extern double Ttinf, Ptinf, Dentinf, utinf, vtinf, Ma, ctinf, Etinf, Htinf, mutinf;//初始来流数据
extern double Tt, Pt, Dent, ut, vt, ct, Et, Ht, mut;//初始来流数据
extern double L;//特征尺寸
